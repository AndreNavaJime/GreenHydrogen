...
tab_clicked = st.radio("Navigate", tab_names, horizontal=True, index=tab_names.index(st.session_state.active_tab))
if tab_clicked != st.session_state.active_tab:
    st.session_state.active_tab = tab_clicked
...
def generate_pdf(row, pred, fig_path=None, full=False):
    ...
    return pdf
# ──────────────────────────────────────────────────────────────────────────────
# 🔄 TAB RENDER LOGIC — replaces all `with tabs[x]:` blocks
# ──────────────────────────────────────────────────────────────────────────────
