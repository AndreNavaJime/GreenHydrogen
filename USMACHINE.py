...
with tabs[3]:
    if calculation_mode != "ML Model":
        ...
        fig_map = px.choropleth(
            ...
            hover_name=None,  # 🔕 No popup text
            hover_data={},     # 🔕 No extra hover
            template="plotly_dark",
        ...
        fig_map.update_layout(coloraxis_showscale=False)  # 🛑 No colorbar
        fig_map.update_layout(margin=dict(l=0, r=0, t=40, b=0))  # 🖼️ Tight margins

        # No "Predicted LCOH by State" subtitle – we already have better info
