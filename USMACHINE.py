...
# (2)  Parameter source selector: DOE baseline vs. custom/sticky
tech_info = {
...
param_source = st.sidebar.radio(
    "Parameter source",
    ["DOE baseline", "Custom / sticky"],
    horizontal=True,
    help=f"DOE baseline pulls technical targets from the DOE: {tech_info.get(tech)}"
)
apply_doe = (param_source == "DOE baseline")
