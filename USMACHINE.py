...
# Use file paths if running locally, otherwise use raw GitHub links
...
if USE_LOCAL:
    ...
    URLs = "https://raw.githubusercontent.com/AndreNavaJime/YOUR_REPO/main/"
    files_info = [
        (URLs + "USAALKALINE.csv", "LCOH_Alk_$kg", "ALKALINE"),
        (URLs + "USAPEM.csv", "LCOH_PEM_$kg", "PEM"),
        (URLs + "USASOEC.csv", "LCOH_SOEC_$kg", "SOEC"),
    ]
