...
with tabs[3]:
    ...
    # ── Plotly config – camera icon kept, logo hidden ────────────────────
    _cfg = {"displaylogo": False}

    # ── 1) Build GeoDataFrame restricted to the lower-48 ────────────────
    LOWER48 = {
    ...
    # ── 2) Styling helper → white background, black text ────────────────
    def _white(fig):
        fig.update_layout(
            paper_bgcolor="white",
            plot_bgcolor="white",
