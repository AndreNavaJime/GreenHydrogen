...
with tabs[3]:
    ...
    if calculation_mode == "ML Model":
        ...
        # ── (B) optional 48-state ML choropleth ─────────────────────────────
        ...
        if show_full:
            ...
            # mini 48-state slice for this Tech & Year
            ...
            preds48 = _predict48(df_sub)          # ← cached helper (defined above)
            ...
            fig_ml = px.choropleth(
                ...
                color="LCOH ($/kg)",
                color_continuous_scale="Viridis",
                range_color=(2, 14),          # identical to Baseline map
                hover_name="State",
