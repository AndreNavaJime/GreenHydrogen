...
def train_models(
    ...
    *,
    ...
    # Optional developer toggle for debug prints
    show_dbg = st.sidebar.checkbox("Show training debug", value=False) if verbose_debug else False
    ...
    all_defs = {
        ...
        # Tree/ensemble models (no scaler)
