...
# Online GeoJSON map with 50 US states
shp_url = "https://raw.githubusercontent.com/PublicaMundi/MappingAPI/master/data/geojson/us-states.json"
gdf = gpd.read_file(shp_url)[["name", "geometry"]].rename(columns={"name": "State"})
