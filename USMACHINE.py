...
row_input = build_model_input(row, results[model_name]["features"])
pred = best.predict(row_input)[0]
...
with tabs[0]:
    ...
    # Optional expansion with full input summary
...
fig_map = px.choropleth(merged, geojson=merged.geometry,
