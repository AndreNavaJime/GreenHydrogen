...
with tabs[3]:
    if calculation_mode == "ML Model":
        ...
        map_df["Highlight"] = map_df["Highlight"].fillna(False).astype(bool)
        ...
        fig_map = px.choropleth(
            ...
            color="Highlight",
            color_discrete_map={True: "#00f5ff", False: "#2c2c2c"},  # Cyan highlight
            hover_data=[],  # Hide index and Highlight=True
            template=None,
        )
