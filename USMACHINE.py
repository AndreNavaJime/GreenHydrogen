...
with tabs[2]:
    ...
    # Distinct Viridis Tech Colors
    tech_colors = {
        "ALKALINE": px.colors.sequential.Viridis[2],
        "PEM": px.colors.sequential.Viridis[5],
        "SOEC": px.colors.sequential.Viridis[8]
    }

    fig_line = px.line(
        df, x="Year", y="LCOH_$kg", color="Tech",
        line_group="State", markers=True,
        template="plotly_dark", color_discrete_map=tech_colors,
        title="LCOH Trends by Tech"
    )
