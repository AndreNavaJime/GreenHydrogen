...
st.markdown("""
<style>
/* Set full background to white and text to black with Times New Roman everywhere */
...
/* Headers (H1-H6) in Times New Roman and black */
h1, h2, h3, h4, h5, h6 {
    color: black !important;
    font-family: 'Times New Roman', Times, serif !important;
}

/* Dropdowns, sliders, buttons — match the theme */
.stSelectbox, .stSlider, .stButton, .stRadio, .stNumberInput, .stTextInput {
    background-color: white !important;
    color: black !important;
    font-family: 'Times New Roman', Times, serif !important;
}

/* Data tables, tabs, etc. */
.css-1cpxqw2, .stTabs, .stDataFrame {
    background-color: white !important;
    color: black !important;
    font-family: 'Times New Roman', Times, serif !important;
}
